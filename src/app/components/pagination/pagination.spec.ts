...
describe('PaginationComponent', () => {
  ...
  it('test pagination - click 2x at next page and click 2x at previous page', inject([Page], (pageService: Page) => {
  ...
  it('test pagination - click at pages in order -> 2, 3 and 1', inject([Page], (pageService: Page) => {
